...
<div class="col-md-4">
                        ...
                        <h2 ><span style="background-color: #ed8323;">Transforming Bus Travel in Nigeria.</span></h2></div>
...
$(document).ready(function(){
 ...
 $(".inputcl").click(function(){
  ...
  $('input.date-pick, .input-daterange input[name="start"]').datepicker({format:'yyyy-mm-dd',autoclose:true}).datepicker('setDate','today');
	  */
$('input.date-pick, .input-daterange input[name="start"]').datepicker('destroy');
$('.input-daterange input[name="end"]').datepicker('destroy');

   if(type == 'round'){
	  
	 
	/* 
var $start = $(".input-daterange").find('input[name="start"]');
var $end = $(".input-daterange").find('input[name="end"]');
...
$end.on('show', function(e){
    ...
    $end.datepicker('setDate','+3d');
}); 
 */
    
$('input.date-pick, .input-daterange input[name="start"]').datepicker({format:'yyyy-mm-dd',autoclose:true}).datepicker('setDate','today');

$('input.date-pick, .input-daterange input[name="end"]').datepicker({format:'yyyy-mm-dd',autoclose:true}).datepicker('setDate','today');
	   $('.returndiv').fadeIn();
   }
   else{
