...
class pjAdmin extends pjAppController
{
	...
	public function pjActionIndex()
	{
		...
		if ($this->isAdmin())
		{
			...
			$latest_bookings = $pjBookingModel
				...
				->select("t1.*, (SELECT SUM(TBT.qty) 
						 	...
						 	AS tickets, t2.departure_time, t2.arrival_time, t3.content as route_title, t4.content as from_location, t5.content as to_location,t6.name as opname")
		...
		{	
			...
			$cnt_routes = $pjRouteModel->where("t1.operator_id",$EditorId)->findCount()->getData();
			$cnt_buses = $pjBusModel->where("t1.operator_id",$EditorId)->findCount()->getData();
