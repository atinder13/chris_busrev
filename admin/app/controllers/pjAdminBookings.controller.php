	...
	public function pjActionGetBooking()
	{
		...
		if ($this->isXHR())
		{
			...
			$pjBookingModel = pjBookingModel::factory()
				...
				->join('pjUser', "t6.id=t2.operator_id AND t6.role_id='2'", 'left outer')
				;
			...
			{
				$data = $pjBookingModel
				->select('t1.*, t2.departure_time, t2.arrival_time, t3.content as route_title, t4.content as from_location, t5.content as to_location,t6.name as opname')
