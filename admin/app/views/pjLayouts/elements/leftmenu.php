...
<div class="leftmenu-middle">
	<ul class="menu">
		...
		if ($controller->isAdmin())
		{
			...
			<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminUsers&amp;action=pjActionIndex" class="<?php echo ($_GET['controller'] == 'pjAdminUsers' && $_GET['action'] == 'pjActionIndex' ) ? 'menu-focus' : NULL; ?>"><span class="menu-users">&nbsp;</span><?php __('menuUsers'); ?></a></li>
			<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminUsers&amp;action=pjActionOperator" class="<?php echo ($_GET['controller'] == 'pjAdminUsers' && $_GET['action'] == 'pjActionOperator' ) ? 'menu-focus' : NULL; ?>"><span class="menu-users">&nbsp;</span>Operators</a></li>
			
			<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminWallet&amp;action=pjActionIndex" class="<?php echo $_GET['controller'] == 'pjAdminWallet' ? 'menu-focus' : NULL; ?>"><span class="menu-reports">&nbsp;</span>Wallet</a></li>
		...
		if ($controller->isEditor())
		{
			...
			<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminBoarding&amp;action=pjActionCreateSlide" class="<?php echo $_GET['controller'] == 'pjAdminBoarding' && $_GET['action'] == 'pjActionCreateSlide' ? 'menu-focus' : NULL; ?>"><span class="menu-users">&nbsp;</span>Slide</a></li>
			<?php
		}
		?>
