...
<html>
	<head>
		<title>Bus Reservation System by PHPJabbers.com</title>
	...
	<body>
		<div id="container">
			<div id="header">
				<div id="logo">
					<a href="http://www.phpjabbers.com/bus-reservation-system/ " target="_blank" rel="nofollow">Bus Reservation System</a>
