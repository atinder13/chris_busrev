						...
						<div class="form-horizontal">
							...
							if (in_array($tpl['option_arr']['o_bf_include_title'], array(2, 3)))
							{
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<select name="c_title" class="form-control pjBsFieldInline<?php echo ($tpl['option_arr']['o_bf_include_title'] == 3) ? ' required' : NULL; ?>">
											<option value="">----</option>
											<?php
							...
							if (in_array($tpl['option_arr']['o_bf_include_fname'], array(2, 3)))
							{
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<input type="text" name="c_fname" class="form-control<?php echo ($tpl['option_arr']['o_bf_include_fname'] == 3) ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_fname']) ? pjSanitize::clean($FORM['c_fname']) : null;?>"/>
							...
							if (in_array($tpl['option_arr']['o_bf_include_lname'], array(2, 3)))
							{
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<input type="text" name="c_lname" class="form-control<?php echo ($tpl['option_arr']['o_bf_include_lname'] == 3) ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_lname']) ? pjSanitize::clean($FORM['c_lname']) : null;?>"/>
							...
							if (in_array($tpl['option_arr']['o_bf_include_phone'], array(2, 3)))
							{
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<input type="text" name="c_phone" class="form-control<?php echo ($tpl['option_arr']['o_bf_include_phone'] == 3) ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_phone']) ? pjSanitize::clean($FORM['c_phone']) : null;?>"/>
							...
							if (in_array($tpl['option_arr']['o_bf_include_email'], array(2, 3)))
							{
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<input type="text" name="c_email" class="form-control email<?php echo ($tpl['option_arr']['o_bf_include_email'] == 3) ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_email']) ? pjSanitize::clean($FORM['c_email']) : null;?>"/>
							...
							if (in_array($tpl['option_arr']['o_bf_include_company'], array(2, 3)))
							{
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<input type="text" name="c_company" class="form-control<?php echo ($tpl['option_arr']['o_bf_include_company'] == 3) ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_company']) ? pjSanitize::clean($FORM['c_company']) : null;?>"/>
							...
							if (in_array($tpl['option_arr']['o_bf_include_notes'], array(2, 3)))
							{
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<textarea name="c_notes" style="height: 100px;" class="form-control<?php echo ($tpl['option_arr']['o_bf_include_notes'] == 3) ? ' required' : NULL; ?>"><?php echo isset($FORM['c_notes']) ? pjSanitize::clean($FORM['c_notes']) : null;?></textarea>
							...
							if (in_array($tpl['option_arr']['o_bf_include_address'], array(2, 3)))
							{
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<input type="text" name="c_address" class="form-control<?php echo ($tpl['option_arr']['o_bf_include_address'] == 3) ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_address']) ? pjSanitize::clean($FORM['c_address']) : null;?>"/>
							...
							if (in_array($tpl['option_arr']['o_bf_include_city'], array(2, 3)))
							{
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<input type="text" name="c_city" class="form-control<?php echo ($tpl['option_arr']['o_bf_include_city'] == 3) ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_city']) ? pjSanitize::clean($FORM['c_city']) : null;?>"/>
							...
							if (in_array($tpl['option_arr']['o_bf_include_state'], array(2, 3)))
							{
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<input type="text" name="c_state" class="form-control<?php echo ($tpl['option_arr']['o_bf_include_state'] == 3) ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_state']) ? pjSanitize::clean($FORM['c_state']) : null;?>"/>
							...
							if (in_array($tpl['option_arr']['o_bf_include_zip'], array(2, 3)))
							{
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<input type="text" name="c_zip" class="form-control<?php echo ($tpl['option_arr']['o_bf_include_zip'] == 3) ? ' required' : NULL; ?>" value="<?php echo isset($FORM['c_zip']) ? pjSanitize::clean($FORM['c_zip']) : null;?>"/>
							...
							if (in_array($tpl['option_arr']['o_bf_include_country'], array(2, 3)))
							{
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<select name="c_country" class="form-control<?php echo ($tpl['option_arr']['o_bf_include_country'] == 3) ? ' required' : NULL; ?>">
											<option value="">----</option>
											<?php
							...
							{ 
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<select id="bsPaymentMethod_<?php echo $_GET['index'];?>" name="payment_method" class="form-control required">
											<option value="">----</option>
											<?php
								...
								<div id="bsCCData_<?php echo $_GET['index'];?>" style="display: <?php echo isset($FORM['payment_method']) && $FORM['payment_method'] == 'creditcard' ? 'block' : 'none'; ?>">
									...
									<div class="form-group">
										...
										<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
											<input type="text" name="cc_num" class="form-control required" value="<?php echo isset($FORM['cc_num']) ? pjSanitize::clean($FORM['cc_num']) : null;?>"/>
									...
									<div class="form-group">
										...
										<div class="col-lg-5 col-md-5 col-sm-4 col-xs-12">
											<select id="bsExpMonth_<?php echo $_GET['index'];?>" name="cc_exp_month" class="form-control required">
												<?php
										...
										<div class="col-lg-5 col-md-4 col-sm-4 col-xs-12">
											<select id="bsExpYear_<?php echo $_GET['index'];?>" name="cc_exp_year" class="form-control required">
												<?php
												$y = (int) date('Y');
												for ($i = $y; $i <= $y + 10; $i++)
												{
									...
									<div class="form-group">
										...
										<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
											<input type="text" name="cc_code" class="form-control required" value="<?php echo isset($FORM['cc_code']) ? pjSanitize::clean($FORM['cc_code']) : null;?>"/>
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-9 col-sm-8 col-xs-12">
										<div class="pjBsCaptcha">
											<input type="text" id="pjBrCaptchaInput" name="captcha" class="form-control<?php echo ($tpl['option_arr']['o_bf_include_captcha'] == 3) ? ' required' : NULL; ?>" maxlength="6" autocomplete="off"/>
											<img id="pjBrCaptchaImage" src="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjFrontEnd&action=pjActionCaptcha&rand=<?php echo rand(1, 9999); ?>" alt="Captcha" style="border: solid 1px #E0E3E8;"/>
										</div><!-- /.pjBsCaptcha -->
