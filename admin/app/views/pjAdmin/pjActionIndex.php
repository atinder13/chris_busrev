					...
					if(count($tpl['latest_bookings']) > 0)
					{
						foreach($tpl['latest_bookings'] as $v)
						{
							...
							<div class="dashboard_row">
								<label><?php echo date($tpl['option_arr']['o_date_format'], strtotime($v['created'])) . ' ' . date($tpl['option_arr']['o_time_format'], strtotime($v['created'])) .'id'.$v['id'];?></label>
								...
								?>
								<label><span>Operator:</span> <?php echo $v['opname'];?></label>
								<label>&nbsp;</label>
