	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminBuses&amp;action=pjActionCreate" method="post" id="frmCreateBus" class="pj-form form">
		...
		<div class="clear_both">
			...
			<p>
				...
				<input type="text" class="pj-form-field w200 required" name="bus_no" id="bus_no" />
				</span>
			</p>
			...
			<p>
				...
				<input type="text" class="pj-form-field w200 required" name="color" id="color" />
				</span>
			</p>
			...
			<p>
				...
				<span class="inline_block">
					...
					?>
				<span class="block b5"><input type="checkbox" id="amenitie" name="amenitie[]" value="<?php echo $Key ?>"  class="r5" /><label for="bs_weekday_monday"><?php echo $Amenitie ;?></label></span>
				<?php } ?>
				</span>
			</p>
