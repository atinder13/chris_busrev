<style>
	a.pj-button.pj-paginator-button-actions{display:none:}
	</style>
<?php
if (isset($tpl['status']))
{
	...
	?>
	var myLabel = myLabel || {};
	myLabel.operator = "Operator";
	myLabel.bookingpay = "Booking Payment";
	myLabel.givepay = "Transfer";
	myLabel.amount = "Balance";
	myLabel.Paystatus = "<?php __('lblStatus'); ?>";
