...
if (!defined("PJ_SCRIPT_VERSION")) define("PJ_SCRIPT_VERSION", "1.1");
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "145");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "1.1.1");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "bus_schedule_");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjBackup', 'pjLog', 'pjInstaller', 'pjOneAdmin', 'pjCountry', 'pjSms', 'pjPaypal', 'pjAuthorize');
?>