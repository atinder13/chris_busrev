	...
	$(function () {
		...
		if ($("#grid").length > 0 && datagrid) {
			...
			var $grid = $("#grid").datagrid({
				...
				columns: [{text: myLabel.title, type: "text", sortable: true, editable: false, width: 150},
				          {text: myLabel.operator, type: "text", sortable: true, editable: false, width: 100},
				          {text: myLabel.from, type: "text", sortable: true, editable: false, width: 100},
				          {text: myLabel.to, type: "text", sortable: true, editable: false, width: 100},
				...
				dataType: "json",
				fields: ['title','opname','from', 'to', 'status'],
				paginator: {
					actions: [
