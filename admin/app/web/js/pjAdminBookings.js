	...
	$(function () {
		...
		if ($("#grid").length > 0 && datagrid) {
			var $grid = $("#grid").datagrid({
				...
				columns: [
				          {text: myLabel.client, type: "text", sortable: false, width:100},
				          {text: myLabel.operator, type: "text", sortable: false, width:100},
				          {text: myLabel.uuid, type: "text", sortable: false, width:100},
				          {text: myLabel.date_time, type: "text", sortable: false, editable: false, width:100},
				...
				dataType: "json",
				fields: ['client','opname','uuid','date_time', 'route_details', 'status'],
				paginator: {
					actions: [
