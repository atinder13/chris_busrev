	...
	$(function () {
		...
		if ($("#grid").length > 0 && datagrid) {
			...
			var $grid = $("#grid").datagrid({
				...
				columns: [{text: myLabel.name, type: "text", sortable: true, editable: false, width: 200},
				         ...
				         {text: myLabel.operator, type: "text", sortable: true, editable: false, width: 100},
				          ...
				          {text: myLabel.seats, type: "text", sortable: true, editable: false, width: 100},
				...
				dataType: "json",
				fields: ['name','opname', 'seats_map', 'seats_count', 'status'],
				paginator: {
					actions: [
