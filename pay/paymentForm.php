    ...
    <body>
        <form method="POST" action="processPayment.php" id="paymentForm">
           ...
           <input type="hidden" name="env" value="test"> 
            <input type="hidden" name="publicKey" value="FLWPUBK-cb2ab02e595bfa15eb37c1829eaeb407-X"> <!-- Put your public key here -->
            <input type="hidden" name="secretKey" value="FLWSECK-6c99d260bfdb8b623bd5c9da9a8040cd-X"> <!-- Put your secret key here -->
